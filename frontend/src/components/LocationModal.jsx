...
const LocationModal = () => {
  ...
  // Escape closes the modal, same as the ✕ button or clicking the backdrop.
  useEffect(() => {
              ...
              <div className="p-5 sm:p-6">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    {modalReason && (
                      <p className={`text-xs sm:text-sm mt-2 leading-relaxed font-medium px-3 py-2 rounded-lg ${
