...
const LoanQuoteCTA = () => {
  ...
  return (
    <button
      onClick={handleClick}
     className="group w-full flex items-center justify-center gap-2 py-3 px-6 bg-yellow-500 hover:bg-yellow-600 text-slate-950 font-bold rounded-2xl shadow-lg hover:shadow-yellow-500/20 transition-all text-sm"
    >
