// src/pages/TravelogueDetail.jsx
/*
================================================================================
File Name : TravelogueDetail.jsx
Author : Tahseen Raza
Created Date : 2026-06-29
Description : Individual travelogue detail page with full theme support
    ...
    <>
        ...
        <div className="container-custom relative z-10 text-white">
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-gray-300 text-sm sm:text-base">
              <span>By {travelogue.author || 'Vaahan Team'}</span>
              <span>•</span>
              <span>{travelogue.date || 'Coming Soon'}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={`py-8 sm:py-12 md:py-16 transition-colors duration-300 ${isDark ? 'bg-dark-900' : 'bg-white'}`}>
        <div className="container-custom">
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            {/* Featured Image - Using image from database */}
            <img
              src={travelogue.image || '/images/travelogue/default.png'}
              ...
              onError={(e) => {
                console.log('⚠️ Image failed to load:', travelogue.image);
