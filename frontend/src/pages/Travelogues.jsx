          ...
          <div className="flex flex-nowrap gap-2 py-2.5 sm:py-3 md:py-4 overflow-x-auto hide-scrollbar">
            {allCategories.map((category) => (
              <button
                ...
                className={`shrink-0 px-3.5 sm:px-4 md:px-5 py-1.5 sm:py-2 rounded-full whitespace-nowrap font-semibold transition-all duration-300 text-xs sm:text-sm md:text-base ${selectedCategory === category.name
