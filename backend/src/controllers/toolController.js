...
Description : Thin HTTP layer for the automotive calculators living in
              ...
              { validate, calculate, format } trio.
Company : Vaahan International
Copyright : (c) 2026 Vaahan International. All rights reserved.
================================================================================
*/

const { calculateEmi } = require('../tools/calculator');
const { validateLoanInput } = require('../tools/validator');
const { formatEmiResult } = require('../tools/formatter');
